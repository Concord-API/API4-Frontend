...
<template>
  <div class="nd-page">
    ...
    <Dialog v-model:open="sheetOpen">
      <DialogContent class="nd-contract-dialog !max-w-[1024px]">
        <DialogHeader class="nd-contract-dialog-header">
        ...
        <form class="nd-contract-form" @submit.prevent="submitForm()">
          <section class="nd-contract-main">
            <div class="nd-contract-section-heading">
              <span class="nd-card-cat">Contrato</span>
          ...
          <aside class="nd-contract-side">
            <div class="nd-contract-section-heading">
              <span class="nd-card-cat">Detalhes</span>
              <strong>Vigência e status</strong>
            </div>

            <div class="nd-field">
              <label class="nd-field-label">Data início *</label>
              <NdDatePicker v-model="form.initialDate" placeholder="Selecionar início" required />
            </div>
            <div class="nd-field">
            ...
            <DialogFooter class="nd-contract-actions">
...
.nd-card-id { font-family: 'Inter', sans-serif; font-size: 11px; letter-spacing: 0.04em; color: var(--nd-text-disabled); }

.nd-contract-dialog,
:deep(.nd-contract-dialog) {
...
.nd-contract-form {
  ...
  min-height: 0;
  max-height: calc(min(86dvh, 720px) - 62px);
  overflow: auto;
}
.nd-contract-main,
.nd-contract-side {
...
.nd-contract-section-heading {
  display: flex;
  flex-direction: column;
  gap: 6px;
}
.nd-contract-section-heading strong {
...
.nd-contract-actions .nd-btn-primary,
.nd-contract-actions .nd-btn-secondary {
  min-height: 34px;
  padding: 7px 12px;
  font-size: 12px;
}
...
.nd-detail-id { font-family: 'Inter', sans-serif; font-size: 13px; letter-spacing: 0.06em; color: var(--nd-text-disabled); }
.nd-tag--lg { font-size: 11px; padding: 4px 12px; }
.nd-detail-section { display: flex; flex-direction: column; gap: 8px; }
.nd-detail-value { font-family: 'Inter', sans-serif; font-size: 16px; color: var(--nd-text-primary); }
.nd-detail-value--mono { font-family: 'Inter', sans-serif; font-size: 13px; letter-spacing: 0.04em; color: var(--nd-text-primary); }
...
.nd-detail-list-sub { font-family: 'Inter', sans-serif; font-size: 10px; letter-spacing: 0.06em; color: var(--nd-text-disabled); margin-left: 4px; }
.nd-detail-footer { margin-top: auto; padding-top: 20px; border-top: 1px solid var(--nd-border); }
.nd-card-name { font-family: 'Inter', sans-serif; font-size: 15px; color: var(--nd-text-primary); line-height: 1.3; margin: 0; }
.nd-card-dates { display: flex; gap: 16px; }
.nd-card-date-item { display: flex; flex-direction: column; gap: 1px; }
.nd-card-date-label { font-family: 'Inter', sans-serif; font-size: 10px; font-weight: 500; letter-spacing: 0.02em; color: var(--nd-text-disabled); }
.nd-card-date-val { font-family: 'Inter', sans-serif; font-size: 11px; letter-spacing: 0.03em; color: var(--nd-text-secondary); }
...
.nd-card-meta-item { font-family: 'Inter', sans-serif; font-size: 10px; font-weight: 500; letter-spacing: 0.02em; color: var(--nd-text-disabled); }

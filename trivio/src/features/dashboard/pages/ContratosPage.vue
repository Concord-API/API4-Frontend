...
.nd-card-date-label { font-family: 'Space Mono', monospace; font-size: 9px; letter-spacing: 0.08em; text-transform: uppercase; color: var(--nd-text-disabled); }
.nd-card-date-val { font-family: 'Space Mono', monospace; font-size: 11px; letter-spacing: 0.03em; color: var(--nd-text-secondary); }
...
.nd-card-meta-item { font-family: 'Space Mono', monospace; font-size: 10px; letter-spacing: 0.06em; text-transform: uppercase; color: var(--nd-text-disabled); }
...
.nd-check-model { font-family: 'Space Mono', monospace; font-size: 10px; letter-spacing: 0.06em; color: var(--nd-text-disabled); }
